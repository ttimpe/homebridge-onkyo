...
class OnkyoAudioReceiverAccessory {
    constructor(platform, accessory, config, log) {
        ...
        this.buttons = {
            ...
            [this.platform.api.hap.Characteristic.RemoteKey.ARROW_UP]: 'up',
            [this.platform.api.hap.Characteristic.RemoteKey.ARROW_DOWN]: 'down',
            [this.platform.api.hap.Characteristic.RemoteKey.ARROW_LEFT]: 'left',
            [this.platform.api.hap.Characteristic.RemoteKey.ARROW_RIGHT]: 'right',
            [this.platform.api.hap.Characteristic.RemoteKey.SELECT]: 'enter',
            [this.platform.api.hap.Characteristic.RemoteKey.BACK]: 'exit',
            [this.platform.api.hap.Characteristic.RemoteKey.EXIT]: 'exit',
            [this.platform.api.hap.Characteristic.RemoteKey.PLAY_PAUSE]: 'play',
            [this.platform.api.hap.Characteristic.RemoteKey.INFORMATION]: 'home',
        };
        this.config = config;
